  ...
  return (
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          Mahmud is a freelance and a full-stack developer based in Dhaka with a
          passion for building digital services/stuff he wants, He has a knack
          for all things launching products, from planning and designing all way
          to solving real-life problems with hanging out with his camera.
          Currently, he is living off of his own prooduct called {''}
